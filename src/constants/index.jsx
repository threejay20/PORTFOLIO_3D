...
export const projects = [
  {
    ...
    name: "Brainwave",
    description:
      "Developed and deployed a sleek UI/UX website with React and Tailwind CSS, showcasing seamless user experiences. Leveraging Reacts modularity and Tailwind CSSs utility-first approach.",
  ...
  },
  {
    ...
    name: "Horizon",
    description:
      "A Next.js financial platform built with TypeScript, Appwrite, Plaid, and Dwolla. It securely connects multiple bank accounts, provides real-time transaction insights, facilitates easy money transfers between users, and helps manage overall finances.",
    link: "https://3jay-banking.vercel.app/sign-in",
  },
  {
    iconUrl: chart,
    theme: "btn-back-red",
    name: "AdminApp",
    description:
      "Developed a web application designed to monitor and oversee a companys performance.",
  ...
  },
  {
    ...
    name: "Exercise App",
    description:
      "Created and deployed a cutting-edge fitness exercises application using React 18, integrated with APIs from RapidAPI for enhanced functionality and seamless user experience.",
  ...
  },
  {
    ...
    name: "Adopt-A-Pet",
    description:
      "A website designed to display a list of adorable animals that are available for adoption.",
...

  {
    ...
    description:
      "Showcased ReactJS and NextJS skills by building Realtor - an impressive Real Estate Application. With rental homes and for-sale properties, advanced property filtering, property details page with an image carousel, and much more.",
